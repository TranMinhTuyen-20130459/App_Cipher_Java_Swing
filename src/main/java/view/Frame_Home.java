...
public class Frame_Home extends JFrame {
    ...
    public void createPanelMenu_MA_HOA_DOI_XUNG() {
        ...
        label_ma_hoa_doi_xung.setIcon(new ImageIcon(Image.img_symmetry));
    ...
    public void createPanelMenu_MA_HOA_BAT_DOI_XUNG() {
        ...
        label_ma_hoa_bat_doi_xung.setIcon(new ImageIcon(Image.img_asymmetrical));
    ...
    public void createPanelMenu_MA_HOA_HASH() {
        ...
        panel_menu_hash.addMouseListener(new PanelButtonMouseAdapter(panel_menu_hash) {
            @Override
            public void mouseClicked(MouseEvent e) {
                showPanel(panel_ma_hoa_hash_text);
        ...
        label_ma_hoa_hash.setIcon(new ImageIcon(Image.img_hash));
    ...
    public void createPanelMenu_CHU_KY_DIEN_TU() {
        ...
        label_chu_ky_dien_tu.setIcon(new ImageIcon(Image.img_signature));
